...
int main(int argc, char** argv){
	int LEN = atoi(argv[1]);
	int x[1000] = {7,3,1,6,7,1,7,6,5,3,1,3,3,0,6,2,4,9,1,9,2,2,5,1,1,9,6,7,4,4,2,6,5,7,4,
	...
	for(i=0; i<=(1000-LEN);i++) {
		...
		for (; start<end; start++){
			...
			//printf("%i,",x[start]);
			if (product == 0) break; //skip when it knows end result will be 0
